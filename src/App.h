...
private:
    ...
    static std::set<std::pair<std::uint32_t, std::uint32_t>> shapeGlyphs(const ft::Font& font, const std::set<std::uint32_t>& utf32codes, bool tabularNumbers, bool slashedZero);
